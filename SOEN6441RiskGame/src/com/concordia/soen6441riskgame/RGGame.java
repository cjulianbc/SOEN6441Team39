...
public class RGGame {
	 ...
	 * the key is an ArrayList (String) that contains all the adjacent countries. 2)
	 * Countries Data Structure: This is a HashMap data structure that contains all
	 ...
	 * coordinate y in the map, continent, owner, and number of armies available.
	 * 
	 * 
	 ...
	 * @param country
	 * @return A ArrayList<String> Of all the countries of the given player that has
	 *         a path in between
	 */
